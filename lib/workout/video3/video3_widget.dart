...
class Video3Widget extends StatefulWidget {
  ...
  static String routeName = 'Video3';
  static String routePath = '/video3';
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 0.0),
                                          child: Text(
                                            'This is the start to your fitness journey',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    '1. Effort Matters More Than Rep Range',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  alignment: AlignmentDirectional(-0.85, 0.0),
                                  child: Text(
                                    '2. Mechanical Tension Is Crucial',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  alignment: AlignmentDirectional(-0.85, 0.0),
                                  child: Text(
                                    '4. Incorporate a Variety of Rep Ranges',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  alignment: AlignmentDirectional(-0.85, 0.0),
                                  child: GradientText(
                                    '5. Prioritize Recovery and Individualization',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
