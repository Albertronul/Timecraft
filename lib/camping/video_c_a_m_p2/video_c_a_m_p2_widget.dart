...
import 'video_c_a_m_p2_model.dart';
export 'video_c_a_m_p2_model.dart';

class VideoCAMP2Widget extends StatefulWidget {
  const VideoCAMP2Widget({super.key});

  static String routeName = 'VideoCAMP2';
  static String routePath = '/videoCAMP2';

  @override
  State<VideoCAMP2Widget> createState() => _VideoCAMP2WidgetState();
}

class _VideoCAMP2WidgetState extends State<VideoCAMP2Widget> {
  late VideoCAMP2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoCAMP2Model());
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  alignment: AlignmentDirectional(-0.85, 0.0),
                                  child: GradientText(
                                    '5. Outdoor Safety and Etiquette',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
