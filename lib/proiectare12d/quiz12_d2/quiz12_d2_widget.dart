...
import 'quiz12_d2_model.dart';
export 'quiz12_d2_model.dart';

class Quiz12D2Widget extends StatefulWidget {
  const Quiz12D2Widget({super.key});

  static String routeName = 'Quiz12D2';
  static String routePath = '/quiz12D2';

  @override
  State<Quiz12D2Widget> createState() => _Quiz12D2WidgetState();
}

class _Quiz12D2WidgetState extends State<Quiz12D2Widget> {
  late Quiz12D2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Quiz12D2Model());
  }
