...
import 'video_c3_model.dart';
export 'video_c3_model.dart';

class VideoC3Widget extends StatefulWidget {
  const VideoC3Widget({super.key});

  static String routeName = 'VideoC3';
  static String routePath = '/videoC3';

  @override
  State<VideoC3Widget> createState() => _VideoC3WidgetState();
}

class _VideoC3WidgetState extends State<VideoC3Widget> {
  late VideoC3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoC3Model());
