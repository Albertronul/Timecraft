...
import 'video_c1_model.dart';
export 'video_c1_model.dart';

class VideoC1Widget extends StatefulWidget {
  const VideoC1Widget({super.key});

  static String routeName = 'VideoC1';
  static String routePath = '/videoC1';

  @override
  State<VideoC1Widget> createState() => _VideoC1WidgetState();
}

class _VideoC1WidgetState extends State<VideoC1Widget> {
  late VideoC1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoC1Model());
