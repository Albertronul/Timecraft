...
import 'video_c2_model.dart';
export 'video_c2_model.dart';

class VideoC2Widget extends StatefulWidget {
  const VideoC2Widget({super.key});

  static String routeName = 'VideoC2';
  static String routePath = '/videoC2';

  @override
  State<VideoC2Widget> createState() => _VideoC2WidgetState();
}

class _VideoC2WidgetState extends State<VideoC2Widget> {
  late VideoC2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoC2Model());
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 0.0),
                                          child: Text(
                                            'This is the start to your cooking journey',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  alignment: AlignmentDirectional(-0.85, 0.0),
                                  child: GradientText(
                                    '5. Foundational egg-cooking skills',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
