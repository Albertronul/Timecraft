...
import 'answers_c2_model.dart';
export 'answers_c2_model.dart';

class AnswersC2Widget extends StatefulWidget {
  const AnswersC2Widget({super.key});

  static String routeName = 'AnswersC2';
  static String routePath = '/answersC2';

  @override
  State<AnswersC2Widget> createState() => _AnswersC2WidgetState();
}

class _AnswersC2WidgetState extends State<AnswersC2Widget> {
  late AnswersC2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnswersC2Model());
  }
