...
import 'quiz3_i_n_f_o_model.dart';
export 'quiz3_i_n_f_o_model.dart';

class Quiz3INFOWidget extends StatefulWidget {
  const Quiz3INFOWidget({super.key});

  static String routeName = 'Quiz3INFO';
  static String routePath = '/quiz3INFO';

  @override
  State<Quiz3INFOWidget> createState() => _Quiz3INFOWidgetState();
}

class _Quiz3INFOWidgetState extends State<Quiz3INFOWidget> {
  late Quiz3INFOModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Quiz3INFOModel());
  }
