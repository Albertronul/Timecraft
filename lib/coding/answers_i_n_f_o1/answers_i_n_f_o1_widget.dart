...
import 'answers_i_n_f_o1_model.dart';
export 'answers_i_n_f_o1_model.dart';

class AnswersINFO1Widget extends StatefulWidget {
  const AnswersINFO1Widget({super.key});

  static String routeName = 'AnswersINFO1';
  static String routePath = '/answersINFO1';

  @override
  State<AnswersINFO1Widget> createState() => _AnswersINFO1WidgetState();
}

class _AnswersINFO1WidgetState extends State<AnswersINFO1Widget> {
  late AnswersINFO1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnswersINFO1Model());
  }
