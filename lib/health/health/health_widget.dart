          ...
          child: FloatingActionButton(
            onPressed: () async {
              ...
              await callAiAgent(
                context: context,
                prompt:
                    'Provide the nutritional information for the food in the image ',
                imageAsset: _model.uploadedLocalFile_uploadImage,
                threadId: getCurrentTimestamp.toString(),
                agentCloudFunctionName: 'foodCamera',
                provider: 'GOOGLE',
                agentJson:
                    "{\"status\":\"LIVE\",\"identifier\":{\"name\":\"foodCamera\",\"key\":\"ayxbq\"},\"name\":\"FoodCamera\",\"description\":\"Food Camera Nutritional Agent\",\"aiModel\":{\"provider\":\"GOOGLE\",\"model\":\"gemini-2.0-flash\",\"parameters\":{\"temperature\":{\"inputValue\":1},\"maxTokens\":{\"inputValue\":8192},\"topP\":{\"inputValue\":0.95}},\"messages\":[{\"role\":\"SYSTEM\",\"text\":\"You are a nutritionist agent. When given an image,  you will look for the food items within it, itemise them and provide the total nutritional content within them. \\nAnd you will never reply with a double type value.\\nYou will never reply with a string value.\\nReply using this schema:\\n{\\n \\\"productName\\\": {\\\"type\\\": \\\"string\\\"},\\n \\\"nutrients\\\": {\\n  \\\"type\\\": \\\"object\\\",\\n  \\\"properties\\\": { \\n    \\\"energy\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"fat\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"saturatedFat\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"carbohydrates\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"sugars\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"fiber\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"proteins\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"salt\\\": { \\\"type\\\": \\\"integer\\\" },\\n    \\\"sodium\\\": { \\\"type\\\": \\\"integer\\\" },\\n  }\\n}\\n\"}]},\"requestOptions\":{\"requestTypes\":[\"PLAINTEXT\",\"IMAGE\"]},\"responseOptions\":{\"responseType\":\"JSON\"}}",
                responseType: 'JSON',
              ).then((generatedText) {
                safeSetState(() => _model.foodCameraOutput = generatedText);
              });

              _model.uploadedimage = _model.uploadedimage;
              safeSetState(() {});
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            if ((_model.uploadedLocalFile_uploadImage.bytes
                                        ?.isNotEmpty ??
                                    false))
                              Align(
                            ...
                            Align(
                              alignment: AlignmentDirectional(-0.88, -0.28),
                              child: Container(
                                width: 200.0,
                                height: 50.0,
                                decoration: BoxDecoration(
                            ...
                            Align(
                              alignment: AlignmentDirectional(-0.89, -0.75),
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 5.0, 0.0, 0.0),
                                child: Text(
