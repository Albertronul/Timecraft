...
import 'video_g_a_r_d4_model.dart';
export 'video_g_a_r_d4_model.dart';

class VideoGARD4Widget extends StatefulWidget {
  const VideoGARD4Widget({super.key});

  static String routeName = 'VideoGARD4';
  static String routePath = '/videoGARD4';

  @override
  State<VideoGARD4Widget> createState() => _VideoGARD4WidgetState();
}

class _VideoGARD4WidgetState extends State<VideoGARD4Widget> {
  late VideoGARD4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoGARD4Model());
