...
import 'video_e1_model.dart';
export 'video_e1_model.dart';

class VideoE1Widget extends StatefulWidget {
  const VideoE1Widget({super.key});

  static String routeName = 'VideoE1';
  static String routePath = '/videoE1';

  @override
  State<VideoE1Widget> createState() => _VideoE1WidgetState();
}

class _VideoE1WidgetState extends State<VideoE1Widget> {
  late VideoE1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoE1Model());
