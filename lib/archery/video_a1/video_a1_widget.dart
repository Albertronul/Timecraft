...
import 'video_a1_model.dart';
export 'video_a1_model.dart';

class VideoA1Widget extends StatefulWidget {
  const VideoA1Widget({super.key});

  static String routeName = 'VideoA1';
  static String routePath = '/videoA1';

  @override
  State<VideoA1Widget> createState() => _VideoA1WidgetState();
}

class _VideoA1WidgetState extends State<VideoA1Widget> {
  late VideoA1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoA1Model());
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 0.0),
                                          child: Text(
                                            'This is the start to your archery journey',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  font: GoogleFonts.inter(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    '1. Introduction to Archery Basics',
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                                          font: GoogleFonts.interTight(
