                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataIpw = true);
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadDataIpw = false;
                            }
                            if (selectedUploadedFiles.length ==
                                    selectedMedia.length &&
                                downloadUrls.length == selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataIpw =
                                    selectedUploadedFiles.first;
                                _model.uploadedFileUrl_uploadDataIpw =
                                    downloadUrls.first;
                              });
                            } else {
                              safeSetState(() {});
                    ...
                    return FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          photoUrl: _model.uploadedFileUrl_uploadDataIpw,
                          username: _model.yourNameTextController2.text,
                        ));

                        await PhotosRecord.collection
                            .doc()
                            .set(createPhotosRecordData(
                              image: _model.uploadedFileUrl_uploadDataIpw,
                            ));
