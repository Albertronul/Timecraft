...
import 'video_p1_model.dart';
export 'video_p1_model.dart';

class VideoP1Widget extends StatefulWidget {
  const VideoP1Widget({super.key});

  static String routeName = 'VideoP1';
  static String routePath = '/videoP1';

  @override
  State<VideoP1Widget> createState() => _VideoP1WidgetState();
}

class _VideoP1WidgetState extends State<VideoP1Widget> {
  late VideoP1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoP1Model());
